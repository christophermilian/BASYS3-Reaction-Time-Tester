...
HD_PWD='C:/Users/chris/Google Drive/FIU Classes/2021 Summer/EEL 4740/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log miniproject_ReflexTester.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source miniproject_ReflexTester.tcl
